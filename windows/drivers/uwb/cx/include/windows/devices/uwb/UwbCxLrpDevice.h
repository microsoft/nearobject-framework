...
#define IOCTL_UWB_DEVICE_RESET                             CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0100, METHOD_BUFFERED, FILE_ANY_ACCESS) // Input: UWB_DEVICE_RESET,                              Output: UWB_STATUS
#define IOCTL_UWB_GET_DEVICE_INFO                          CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0101, METHOD_BUFFERED, FILE_ANY_ACCESS) // Input: nullptr,                                       Output: UWB_DEVICE_INFO
#define IOCTL_UWB_GET_DEVICE_CAPABILITIES                  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0102, METHOD_BUFFERED, FILE_ANY_ACCESS) // Input: nullptr,                                       Output: UWB_DEVICE_CAPABILITIES
...
#define IOCTL_UWB_SESSION_INIT                             CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0105, METHOD_BUFFERED, FILE_ANY_ACCESS) // Input: UWB_SESSION_INIT,                              Output: UWB_STATUS
...
#define IOCTL_UWB_STOP_RANGING_SESSION                     CTL_CODE(FILE_DEVICE_UNKNOWN, 0x010D, METHOD_BUFFERED, FILE_ANY_ACCESS) // Input: UWB_STOP_RANGING_SESSION,                      Output: UWB_STATUS
...
enum UWB_CAPABILITY_PARAM_TYPE {
    ...
    UWB_CAPABILITY_PARAM_TYPE_DEVICE_CLASS
};
