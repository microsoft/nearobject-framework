...
{
    winrt::hstring UwbSessionData::SessionId()
    {
        return m_sessionId;
    }
    void UwbSessionData::SessionId(winrt::hstring const& value)
    {
    ...
    void UwbSessionData::DeviceRole(winrt::OobSimulator::DeviceRole const& value)
    {
    ...
    void UwbSessionData::MultiNodeMode(winrt::OobSimulator::MultiNodeMode const& value)
    {
    ...
    void UwbSessionData::ControllerMacAddress(hstring const& value)
    {
    ...
    void UwbSessionData::ControleeShortMacAddress(hstring const& value)
    {
    ...
    void UwbSessionData::PropertyChanged(winrt::event_token const& token) noexcept
    {
