...
namespace winrt::OobSimulator::implementation
{
    ...
    void MainWindow::SetUwbSessionData(UwbSessionData const& uwbSessionData, std::string const& outputDirectory)
    {
    ...
    void MainWindow::SetUwbSessionData_Click(IInspectable const&, RoutedEventArgs const&)
    {
